        ...
        <header className="flex items-center justify-between border-b border-line/80 px-5 py-4">
          <div className="flex items-center gap-3">
            <Link
              ...
              className="flex h-11 min-w-11 items-center justify-center rounded-md border border-line bg-surface px-2.5 text-ink-muted transition-colors hover:text-forest"
            >
