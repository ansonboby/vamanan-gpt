...
const FALLBACKS: Fallback[] = [
  /* ── identity ─────────────────────────────────────────────── */
  {
    id: "identity",
    test:
      /\b(who are you|what are you|your name|introduce yourself)\b|നീ ആരാണ്|ആരാണ് നീ/i,
    replies: [
  ...
  /* ── why onam ─────────────────────────────────────────────── */
  {
    id: "why-onam",
    test:
      /\b(why|how come|reason)\b[\s\S]*\b(onam|celebrat)|ഓണം എന്തിന്|എന്തുകൊണ്ട് ഓണം|ഓണം എന്തുകൊണ്ട്/i,
    replies: [
  ...
  {
    id: "mahabali",
    test: /\b(mahabali|maveli|onathappan)\b|മഹാബലി|മാവേലി/i,
    replies: [
  ...
  {
    id: "vamana",
    test: /\b(vamana|dwarf)\b|വാമനൻ|വാമന/i,
    replies: [
  ...
  /* ── pookalam ─────────────────────────────────────────────── */
  {
    id: "pookalam",
    test:
      /\b(pookalam|pookkalam|flower carpet|athapookalam|rangoli)\b|പൂക്കളം|പൂവിതാനം|അത്തപ്പൂക്കളം|പുഷ്പാലങ്കാര/i,
    replies: [
  ...
  /* ── sadya ────────────────────────────────────────────────── */
  {
    id: "sadya",
    test:
      /\b(sadya|feast|food|banana leaf|ona?sadya|payasam)\b|സദ്യ|പായസം|ഭക്ഷണം|അട ഓണസദ്യ/i,
    replies: [
  ...
  /* ── vallam kali ──────────────────────────────────────────── */
  {
    id: "vallam",
    test:
      /\b(vallam|snake boat|boat race|aranmula|alleppey|alappuzha|chundan)\b|വള്ളം|വള്ളംകളി|ചുണ്ടൻ|പായിപ്പാട്|ആറന്മുള/i,
    replies: [
  ...
  {
    id: "malayalam",
    test: /\b(malayalam|your language|teach me a word)\b|മലയാളം|ഭാഷ/i,
    replies: [
  ...
  {
    id: "kerala",
    test: /\b(kerala|god'?s own country|backwater)\b|കേരളം/i,
    replies: [
  ...
  /* ── arts ─────────────────────────────────────────────────── */
  {
    id: "arts",
    test:
      /\b(kathakali|theyyam|mohiniyattam|thiruvathira|dance|art form)\b|കഥകളി|തെയ്യം|മോഹിനിയാട്ടം|തിരുവാതിര/i,
    replies: [
  ...
  /* ── greeting ─────────────────────────────────────────────── */
  {
    id: "greeting",
    test:
      /\b(hello|hi|hey|namaskaram|namaste|good (morning|evening|afternoon))\b|നമസ്‌കാരം|സുഖമാണോ|സ്വാഗതം/i,
    replies: [
  ...
  {
    id: "humor",
    test: /\b(funny|joke|laugh|humou?r)\b|തമാശ|കഥ പറയൂ രസം/i,
    replies: [
  ...
  /* ── surprise ─────────────────────────────────────────────── */
  {
    id: "surprise",
    test:
      /\b(surprise|tell me something|anything|random|fact)\b|വിസ്മയം|എന്തെങ്കിലും പറയൂ|പുതിയത് പറയൂ/i,
    replies: [
  ...
  {
    id: "quiz",
    test: /\b(quiz|challenge|test me|question me)\b|ക്വിസ്|ചോദ്യം|പരീക്ഷിക്കൂ/i,
    replies: [
  ...
  {
    id: "thanks",
    test: /\b(thanks|thank you|nanni)\b|നന്ദി|നന്ദിയായി/i,
    replies: [
  ...
  {
    id: "farewell",
    test: /\b(bye|goodbye|see you|farewell|later)\b|വിട|പോകുന്നു|പോകട്ടെ/i,
    replies: [
...
const MORE =
  /\b(more|again|another|continue|next|go on|tell me more|what else|else)\b|കൂടുതൽ|ഇനിയും|പറയൂ|തുടരുക/i;
...
export function localReply(
  ...
  // [^\p{L}]+ = no letters of ANY script — so Malayalam (which has no
  // ASCII word chars) is never mistaken for gibberish, only true
  // digits/punctuation/emoji-only input is.
  if (/^[^\p{L}]+$/u.test(m) && m.length <= 24) {
    return {
      reply:
